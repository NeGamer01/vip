...
UPDATE="https://raw.githubusercontent.com/NeGamer01/vip/main/update/update.sh"
GREEN='\033[0;32m'
RED='\033[0;31m'
ipsaya=$(wget -qO- ipinfo.io/ip)
data_server=$(curl -v --insecure --silent https://google.com/ 2>&1 | grep Date | sed -e 's/< Date: //')
date_list=$(date +"%Y-%m-%d" -d "$data_server")
data_ip="https://raw.githubusercontent.com/NeGamer01/izin/main/ip"
checking_sc() {
...
Exp=$(curl -sS https://raw.githubusercontent.com/NeGamer01/izin/main/ip | grep $MYIP | awk '{print $3}')
fi
